...
using Login = KpiScope.Web.Login;
using Ardalis.SharedKernel;
using KpiScope.Core.UserAggregate.Specifications;

namespace KpiScope.Web;

public class JwtTokenService(IRepository<UserAgg.User> _userRepository, IOptions<JwtOptions> _options)
{
    public async Task<SecurityToken> GenerateTokenAsync(Login.LoginRequest req)
    {
