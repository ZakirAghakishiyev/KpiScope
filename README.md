...
To update the database use this command from the Web project folder (replace `KpiScope` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../KpiScope.Infrastructure/KpiScope.Infrastructure.csproj -s KpiScope.Web.csproj
```
